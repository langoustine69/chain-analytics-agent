...
type AgentHttpHandlers = {
     ...
     */
    invoke: (req: Request, params: {
        key: string;
    }) => Promise<Response>;
    /**
     * Stream from an entrypoint handler.
     */
    stream: (req: Request, params: {
        key: string;
    }) => Promise<Response>;
    /**
     ...
     */
    cancelTask: (req: Request, params: {
        taskId: string;
    }) => Promise<Response>;
    /**
     * Subscribe to task updates via SSE (A2A Protocol).
     */
    subscribeTask: (req: Request, params: {
        taskId: string;
    }) => Promise<Response>;
};

export type { AgentHttpHandlers, FetchFunction, HttpExtensionOptions, StreamAssetEnvelope, StreamAssetExternalTransfer, StreamAssetInlineTransfer, StreamControlEnvelope, StreamDeltaEnvelope, StreamEnvelope, StreamEnvelopeBase, StreamErrorEnvelope, StreamPushEnvelope, StreamResult, StreamRunEndEnvelope, StreamRunStartEnvelope, StreamTextEnvelope, StreamUsage };
